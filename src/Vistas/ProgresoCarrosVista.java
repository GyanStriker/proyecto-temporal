...
public class ProgresoCarrosVista extends javax.swing.JFrame {

    public ProgresoCarrosVista() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProgresoCarrosVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProgresoCarrosVista().setVisible(true);
            }
        });
    }
